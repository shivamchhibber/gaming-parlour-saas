...
const Navbar = (props) => {
  ...
  return (
    <nav className="sticky top-1.5 z-40 flex flex-row flex-wrap items-center justify-between rounded-xl bg-white/10 p-2 backdrop-blur-xl dark:bg-[#0b14374d]">
              ...
              <div className="p-4">
                <div className="flex items-center gap-2">
                  <p className="text-sm font-bold text-navy-700 dark:text-white">
                    👋 Hey, {currentUser?.username || 'Admin'}
                  </p>{" "}
                </div>
